...
const { getRoles, getRoleChoices, createRole } = require("./src/roles");
const {
  getDepartments,
    ...
    .prompt([
      {
        ...
        validate: (nameInput) => {
          if (nameInput) {
            ...
            console.log("Please provide the name of the department!.");
          }
        },
      },
    ])
    ...
    .prompt([
      {
        ...
        validate: (titleInput) => {
          if (titleInput) {
            ...
            console.log("Please provide the title of the role!.");
          }
        },
      },
      ...
      },
      {
        ...
        validate: (departmentID) => {
          if (departmentID) {
            ...
            console.log("Please provide the department!.");
          }
        },
      },
    ])
